...
public class PullToRefreshListView extends ListView implements OnScrollListener {
	...
	private OnClickRefreshListener mOnClickRefreshListener = new OnClickRefreshListener();
	...
	private void init(Context context) {
		...
		mRefreshView.setOnClickListener(mOnClickRefreshListener);
		...
		mLoadView.setOnClickListener(new OnClickRefreshFooterListener());
	...
	public void onRefresh() {
		Log.d(TAG, "onRefresh");
		//点击后的刷新，这样子类中可调用onRefresh而不用管是点击还是下拉
		if (mRefreshState == TAP_TO_REFRESH) {
			mOnClickRefreshListener.onClick(mRefreshView);
	...
	public void onRefreshFooterComplete() {
		Log.d(TAG, "onRefreshFooterComplete");
	...
	private class OnClickRefreshFooterListener implements OnClickListener {

		public void onClick(View v) {
			if (mRefreshFooterState != REFRESHING) {
				onRefreshFooter();
			}
		}
